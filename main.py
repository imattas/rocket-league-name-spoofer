...
class SpooferGUI:
    ...
    def _create_all_widgets(self):
        ...
        self.credit_label = ctk.CTkLabel(credits_footer_frame, text="Made by imattas", font=self.font_credit, text_color=self.COLORS["status_idle"])
